...
# This class contains the shared values used in the project accross different modules
class sharedValuesConfig:
    ...
    D_REF = 1e3                                                             ## reference value for dB conversion --> value from analysing the dataset
    D_MIN = 1e-12                                                           ## larger than 0 to avoid log(0)  --> value from analysing the dataset
    TOP_DB_ABS = abs(10*np.log10(D_MIN))                                    ## maximum dB value -> 10*log(a_squere_min) = -120
